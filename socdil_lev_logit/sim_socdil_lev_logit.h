...
public:
	...
	inline constexpr static auto name() { return "socdil_lev_logit"; }	/*UC: returns the name of the simulation */
...
private:
	...
	SimParameter d{"delta", 1.0, "temptation to choose defection"};	/* USEFUL! This is how a parameter is defined: SimParameter parameter{"Parameter name", parameter value, "Parameter description"} */
	SimParameter e{"epsilon", 0.5, "reward for cooperation"};
