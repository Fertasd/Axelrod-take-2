...
Sim_socdil_lev_imit::Sim_socdil_lev_imit(size_t width) : Simulation(width), data2(width * width)
...
{
	return {startselect, e, d, zz, Temp};		/* UC: adjust this list to only show the parameters you actually have in your simulation. */
}
...
std::string Sim_socdil_lev_imit::getName() const
{
	return "socdil_lev_imit";		/* UC: returns the name of the simulation for internal purposes. */
}
...
size_t Sim_socdil_lev_imit::returnSpecies()
{
	return Ns;
}
