...
class Sim_tox2xreal : public Simulation
{
public:
	Sim_tox2xreal(size_t width = 300);						    /*UC: declares a simulation with given width */
	inline constexpr static auto name() { return "tox2xreal"; } /*UC: returns the name of the simulation */
...
private:
	...
	static constexpr uint8_t Ns = 9;											/* UC: number of species/strategies               */
