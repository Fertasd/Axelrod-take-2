...
{	/* upon the creation of an object of this class, the following happens: */
	...
	auto changedEvent = [=] (double) {	/* UC: the payoff matrix is defined here, it must be defined in this fashion to work */
		pm[0][0] = 0; pm[0][1] = 2; pm[0][2] = 2; pm[0][3] = 4; pm[0][4] = 4; pm[0][5] = 2; pm[0][6] = 2; pm[0][7] = 4; pm[0][8] = 2;
		pm[1][0] = 1; pm[1][1] = 0; pm[1][2] = 1; pm[1][3] = 5; pm[1][4] = 1; pm[1][5] = 4; pm[1][6] = 2; pm[1][7] = 3; pm[1][8] = 2;
		pm[2][0] = 1; pm[2][1] = 2; pm[2][2] = 0; pm[2][3] = 1; pm[2][4] = 5; pm[2][5] = 2; pm[2][6] = 4; pm[2][7] = 3; pm[2][8] = 2;
		pm[3][0] = 5; pm[3][1] = 4; pm[3][2] = 2; pm[3][3] = 0; pm[3][4] = 3; pm[3][5] = 4; pm[3][6] = 2; pm[3][7] = 4; pm[3][8] = 2;
		pm[4][0] = 5; pm[4][1] = 2; pm[4][2] = 4; pm[4][3] = 3; pm[4][4] = 0; pm[4][5] = 2; pm[4][6] = 4; pm[4][7] = 4; pm[4][8] = 2;
		pm[5][0] = 1; pm[5][1] = 5; pm[5][2] = 1; pm[5][3] = 5; pm[5][4] = 1; pm[5][5] = 0; pm[5][6] = 3; pm[5][7] = 5; pm[5][8] = 4;
		pm[6][0] = 1; pm[6][1] = 1; pm[6][2] = 5; pm[6][3] = 1; pm[6][4] = 5; pm[6][5] = 3; pm[6][6] = 0; pm[6][7] = 5; pm[6][8] = 4;
		pm[7][0] = 5; pm[7][1] = 3; pm[7][2] = 3; pm[7][3] = 5; pm[7][4] = 5; pm[7][5] = 4; pm[7][6] = 4; pm[7][7] = 0; pm[7][8] = 4;
		pm[8][0] = 1; pm[8][1] = 1; pm[8][2] = 1; pm[8][3] = 1; pm[8][4] = 1; pm[8][5] = 5; pm[8][6] = 5; pm[8][7] = 5; pm[8][8] = 0;
	};
	changedEvent(0);
...
std::vector<SimParameter> Sim_tox2xreal::parameters()
{
	return {startselect, Px, alfa/*, Su*/}; /* UC: adjust this list to only show the parameters you actually have in your simulation. */
}

uint32_t Sim_tox2xreal::animationDelay() const
{
...
std::string Sim_tox2xreal::getName() const
{
	return "tox2xreal";		/* UC: returns the name of the simulation for internal purposes. */
}

void Sim_tox2xreal::step()		/* defines a simulation step */
{
...
void Sim_tox2xreal::reset()		/* creates a specific strategy distribution across the grid */
{
...
size_t Sim_tox2xreal::returnSpecies()
{
	return Ns;			/* Returns the number of strategies. */
}

size_t Sim_tox2xreal::stepTargetNumber() const
{
