...
{
public:
	Sim_tox2x(size_t width = 300);						    /*UC: declares a simulation with given width */
	inline constexpr static auto name() { return "tox2x"; } /*UC: returns the name of the simulation */
