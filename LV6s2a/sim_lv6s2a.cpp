...
Sim_LV6s2a::Sim_LV6s2a(size_t width) : Simulation(width), data2(width * width)
...
{	/* upon the creation of an object of this class, the following happens: */
	auto changedEvent = [=] (double) {	/* UC: the payoff matrix is defined here, it must be defined in this fashion to work */
		pm[0][0] = 0; pm[0][1] = 1; pm[0][2] = 1; pm[0][3] = 2; pm[0][4] = 3; pm[0][5] = 3;
		pm[1][0] = 3; pm[1][1] = 0; pm[1][2] = 1; pm[1][3] = 1; pm[1][4] = 2; pm[1][5] = 3;
		pm[2][0] = 3; pm[2][1] = 3; pm[2][2] = 0; pm[2][3] = 1; pm[2][4] = 1; pm[2][5] = 2;
		pm[3][0] = 2; pm[3][1] = 3; pm[3][2] = 3; pm[3][3] = 0; pm[3][4] = 1; pm[3][5] = 1;
		pm[4][0] = 1; pm[4][1] = 2; pm[4][2] = 3; pm[4][3] = 3; pm[4][4] = 0; pm[4][5] = 1;
		pm[5][0] = 1; pm[5][1] = 1; pm[5][2] = 2; pm[5][3] = 3; pm[5][4] = 3; pm[5][5] = 0;
	};
...
std::string Sim_LV6s2a::getName() const
{
	return "LV6s2a";		/* UC: returns the name of the simulation for internal purposes. */
}
...
void Sim_LV6s2a::reset()		/* creates a specific strategy distribution across the grid */
{
...
size_t Sim_LV6s2a::returnSpecies()
{
	return Ns;
}
